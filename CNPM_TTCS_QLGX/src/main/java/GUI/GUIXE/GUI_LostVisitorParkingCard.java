...
public class GUI_LostVisitorParkingCard extends javax.swing.JPanel {
    ...
    public void updateLostVisitorParkingCard(){
        ...
        callLogMessage(r);
        fillTable();
        List<LostVisitorParkingCards> arr = dataGlobal.getArrayLostVisitorParkingCardses();
        ParkingSession ps = DAO.ParkingSessionDAO.getInstance().findbyID(sID);
        
        jTextField3.setText(String.valueOf(ps.getVehicle_id()) );
        jTextField4.setText(ps.getCheck_in_time().toString());
    }
