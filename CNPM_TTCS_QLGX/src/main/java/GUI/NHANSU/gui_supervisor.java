 ...
 * @author eramisme
 */
public class gui_supervisor extends javax.swing.JPanel {

    /**
     * Creates new form gui_supervisors
     */
    public gui_supervisor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Giám sát", "ID Quản lý", "ID Nhân viên"
            }
        ) {
        ...
        if (jTable2.getColumnModel().getColumnCount() > 0) {
            jTable2.getColumnModel().getColumn(1).setHeaderValue("ID Quản lý");
        }
